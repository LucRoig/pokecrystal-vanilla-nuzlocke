...
PryceGroup:
	...
	db 28, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 30, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	; JASMINE (1): Battle for the 5th gym badge
	db "JASMINE@", TRAINERTYPE_MOVES
	db 27, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 28, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 30, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end
	; JASMINE (2): Battle for the 6th gym badge
	db "JASMINE@", TRAINERTYPE_MOVES
	db 31, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 32, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 34, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end
	; JASMINE (3): Battle for the 7th gym badge
	db "JASMINE@", TRAINERTYPE_MOVES
	db 34, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 35, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 37, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1): Battle for the 5th gym badge
	...
	db -1 ; end
	; CHUCK (2): Battle for the 6th gym badge
	db "CHUCK@", TRAINERTYPE_MOVES
	db 32, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 34, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
	; CHUCK (3): Battle for the 7th gym badge
	db "CHUCK@", TRAINERTYPE_MOVES
